...
(function (factory) {
	...
	function Datepicker() {
		...
		this._inlineClass = "calWrap"; // The name of the inline marker class
	...
	$.extend(Datepicker.prototype, {
		...
		_generateHTML: function (inst) {
			...
			prev = (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ?
				"<button class='btnMonth prevMonth ui-corner-all' type='button' data-handler='prev' data-event='click'" +
				" title='" + prevText + "'><span class='ui-icon ui-icon-circle-triangle-" + (isRTL ? "e" : "w") + "'>" + prevText + "</span></button>" :
				(hideIfNoPrevNext ? "" : "<button disabled class='btnMonth prevMonth ui-corner-all ui-state-disabled' type='button' title='" + prevText + "'><span class='ui-icon ui-icon-circle-triangle-" + (isRTL ? "e" : "w") + "'>" + prevText + "</span></button>"));
			...
			next = (this._canAdjustMonth(inst, +1, drawYear, drawMonth) ?
				"<button class='btnMonth nextMonth ui-corner-all' type='button' data-handler='next' data-event='click'" +
				" title='" + nextText + "'><span class='ui-icon ui-icon-circle-triangle-" + (isRTL ? "w" : "e") + "'>" + nextText + "</span></button>" :
				(hideIfNoPrevNext ? "" : "<button class='btnMonth nextMonth ui-corner-all ui-state-disabled' type='button' title='" + nextText + "'><span class='ui-icon ui-icon-circle-triangle-" + (isRTL ? "w" : "e") + "'>" + nextText + "</span></button>"));
			...
			for (row = 0; row < numMonths[0]; row++) {
				...
				for (col = 0; col < numMonths[1]; col++) {
					...
					if (isMultiMonth) {
						...
						if (numMonths[1] > 1) {
							switch (col) {
								case 0: calender += " calInner calLeft";
									cornerClass = " ui-corner-" + (isRTL ? "right" : "left"); break;
								case numMonths[1] - 1: calender += " calInner calRight";
									cornerClass = " ui-corner-" + (isRTL ? "left" : "right"); break;
								default: calender += " calInner ui-datepicker-group-middle"; cornerClass = ""; break;
							}
						}
						calender += "'>";
					}
							...
							tbody += "<td class='" +
								...
								(otherMonth && !showOtherMonths ? "&#xa0;" : // display for other months
									(unselectable ? "<span class='ui-state-default default'>" + printDate.getDate() + "</span>" : "<a class='ui-state-default" +
										...
										"'"
										+ (String(daySettings[1]).indexOf('revOn') != -1 ? " title='" + chkInTitle + "'" : "")
										+ (String(daySettings[1]).indexOf('revOff') != -1 ? " title='" + chkOutTitle + "'" : "")
										+ " href='#'>"
